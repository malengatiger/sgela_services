...
import '../sgela_util/functions.dart' as fun;
import '../sgela_util/functions.dart';
...
class GeminiChatService {
  ...
  Future<String> sendGenericImageTextPrompt(
    ...
    var compressed = await compressImages(file: imageFile, quality: 80);
    if (compressed == null) {
    ...
    if (compLength > (1024 * 1024 * 3)) {
      compressed = await compressImages(file: imageFile, quality: 64);
      if (compressed == null) {
